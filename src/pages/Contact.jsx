    ...
    <DefaultLayout>
      ...
      >
        ...
        <p className="text-2xl text-gray-700 mb-8">
          Let's Create Memorable Moments Together - Reach Out and Plan Your
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <img
            src="/counter.jpg"
            alt="/"
            className="w-full hidden lg:block object-contain p-2 max-h-[700px] mt-8 ml-8"
          />
          <div className="flex flex-wrap w-full max-w-[600px] mx-auto">
            <input
              className="border m-2 p-3 w-full"
              type="text"
            ...
            />
            <textarea
              className="border col-span-3 m-2 p-2 w-full"
